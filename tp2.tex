...
\end{figure*}
\anotacion[ForestGreen]{Nota: En la instancia de la clase Materia, se podria almacenar todos los alumnos inscriptos, o que cada instancia de Alumno contener todas las materias a las que esta inscripto; aun no decidimos como resolverlo.}
\pagebreak
\section*{Dudas:}
\begin{figure*}[h]
    \centering
